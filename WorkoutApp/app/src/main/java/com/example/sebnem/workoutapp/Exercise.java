...
public abstract class Exercise {
    ...
    public static final Exercise[] exercises = {
            ...
            new Muscle("Barbell Shrugs","",R.drawable.barbell_shrugs,"Barbell"),
            new Muscle("Bench Press","",R.drawable.bench_press,"Bench"),
            ...
            new Muscle("Dumbbell Flys","",R.drawable.dumbbell_flys,"Dumbbell"),
            new Muscle("Dumbbell Lunges","",R.drawable.dumbbell_lunges,"Dumbbell"),
            new Muscle("Front Dumbbell Raise","",R.drawable.front_dumbbell_raise,"Dumbbell"),
            ...
            new Muscle("Pull Ups","",R.drawable.pull_ups,"N/A"),
            new Muscle("Push Ups","",R.drawable.push_ups,"N/A"),
            new Muscle("Seated Barbell Shoulder Press","",R.drawable.seated_barbell_shoulder_press,"Barbell"),
            ...
            new Muscle("Squats Using Dumbbells","",R.drawable.squats_using_dumbbells,"Dumbbells"),
